...
| Adapter API | exactly `0.1.0-alpha.2` | commit `e81f08bc4bfbf02d810ec8949a019130e2e61634`; source tree `2f974c9bb2ba13888d69682f86f30f58922d30eb`; four source-compiled classes |
...
an accepted runtime identity. The Adapter API pin centralizes only the four
repeated integration primitives and does not broaden that runtime gate.
